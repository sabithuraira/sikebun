...
<div class="card" id="app_vue">
    ...
    <table class="table-border" style="min-width:100%">
        ...
        <tr>
            ...
            <td>
                PMDN -1 &nbsp;&nbsp;&nbsp; PMA -2 &nbsp;&nbsp;
                <input class="float-right" disabled type="text" name="status_pemodalan_grup" v-model="form.status_pemodalan_grup" size="1">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input class="float-right" disabled type="text" name="badan_hukum_grup" v-model="form.badan_hukum_grup" size="1">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                Ya -1 &nbsp;&nbsp;&nbsp; Tidak -2 &nbsp;&nbsp;
                <input class="float-right" disabled type="text" name="apakah_pelaksana_kemitraan" v-model="form.apakah_pelaksana_kemitraan" size="1"></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                Ya -1 &nbsp;&nbsp;&nbsp; Tidak -2 &nbsp;&nbsp;
                <input class="float-right" disabled type="text" name="punya_kebun_plasma" v-model="form.punya_kebun_plasma" size="1"></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                Ya -1 &nbsp;&nbsp;&nbsp; Tidak -2 &nbsp;&nbsp;
                <input class="float-right" disabled type="text" name="punya_unit_pengolahan" v-model="form.punya_unit_pengolahan" size="1"></td>
        </tr>
