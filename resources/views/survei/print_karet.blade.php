...
<html lang="en">
    ...
    <body>
        ...
        <table class="table-border border-orange" style="min-width:100%">
            <tr align="center" class="bg-orange"><td colspan="4"><b>I. PENGENALAN TEMPAT</b></td></tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2" align="center" class="bg-orange"><b>II. KETERANGAN PETUGAS</b></td>
            </tr>
        ...
        <table width="100%">
            <tr>
                <td width="70%">
                    <div class="table-border border-orange">
        ...
        <table class="table-border border-orange" width="100%">
            <tr><td colspan="16" align="center" class="bg-orange"><b>III. LUAS TANAMAN, PRODUKSI DAN DISTRIBUSI PRODUKSI</b></td></tr>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td> {{ $model['301_b_bulan1'] }}</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                <td>{{ $model['301_b_bulan2'] }}
                </td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                <td>{{ $model['301_b_bulan3'] }}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="16" align="center" class="bg-orange"><b>IV. CATATAN DAN PENGESAHAN</b></td>
            </tr>
