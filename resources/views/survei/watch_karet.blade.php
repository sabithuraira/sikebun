...
<table style="min-width:100%">
    ...
    <table class="table-border" style="min-width:100%">
        ...
        <tr>
            ...
            <td>&nbsp;&nbsp;&nbsp; b. Provinsi</td>
            <td>
                <select name="kode_prov_grup" disabled v-model="form.kode_prov_grup" @change="setKab()">
        ...
        <tr>
            ...
            <td>&nbsp;&nbsp;&nbsp; c. Kabupaten/Kota *)</td>
            <td>
                <select name="kode_kab_grup" disabled v-model="form.kode_kab_grup">
        ...
        <tr>
            ...
            <td><input disabled type="text" disabled name="nama_kantor_pusat" v-model="form.nama_kantor_pusat"></td>
    ...
    <table class="table-border" style="min-width:100%">
        ...
        <tr>
            ...
            <td colspan="7">
                ...
                <input disabled type="text" name="diisi_di" v-model="form.diisi_di">, <input disabled class="datetimepicker4" id="diisi_tanggal" type="text" name="diisi_tanggal" :value="form.diisi_tanggal"> <br/>
