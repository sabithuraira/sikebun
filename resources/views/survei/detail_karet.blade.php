...
<table style="min-width:100%">
    ...
    <table class="table-border" style="min-width:100%">
        ...
        <tr>
            <td>&nbsp;&nbsp;&nbsp; b. Provinsi</td>
            <td>
                <input type="text" name="kode_prov_kantor_pusat" disabled v-model="form.kode_prov_kantor_pusat">
    ...
    <table class="table-border" style="min-width:100%">
        ...
        <tr>
            ...
            <td colspan="7">
                ...
                <input type="text" name="diisi_di" v-model="form.diisi_di">, <input class="datetimepicker4" type="text" name="diisi_tanggal" v-model="form.diisi_tanggal"> <br/>
